...
class Bot(BaseBot):
  ...
  async def on_start(self, session_metadata: SessionMetadata) -> None:
    ...
    self.highrise.tg.create_task(
        ...
        Position(x=14.5, y=16.5, z=6.0, facing='FrontRight')))
  ...
  async def on_user_join(self, user: User,
    ...
    if self.room_open:
     await self.highrise.send_whisper(user.id, "welcome to our free item room, please stand in line, if not we will kick you 😊")
    else:
  ...
  async def on_chat(self, user: User, message: str) -> None:
      ...
      if command == "!summon" and selected_users:
          ...
          for target_user in target_users:
              ...
              elif command == "!up" and user.username in vip:
                await self.highrise.teleport(target_user.id, self.user_teleport_positionU)
              elif command == "!down" and user.username in vip:
                await self.highrise.teleport(target_user.id, self.user_teleport_positionD)
...
bot_file_name = "main"
bot_class_name = "Bot"
room_id = "66b1c2a918ac85ed6283dc9a"
bot_token = "cbbf4bf2e30cbe1990387e6f50256c3ed302596e60baeb76e55db7c0e632bbc0"
# hers 93da8356e48ad1547d8c03441de09096852d1538958c02c0e2a2be99639f4bd3 rid:668660dd6f08c48912635e83
# mine 24e6088cf133602810245308c100b920c4f7b270db286b3215b0f21409195130
